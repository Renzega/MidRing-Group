...
<head>
    ...
    <!-- CSS LIBRARY -->
    <link rel="stylesheet" type="text/css" href="core/assets/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="core/assets/css/ionicons.min.css">
    <link rel="stylesheet" type="text/css" href="core/assets/css/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="core/assets/css/gallery.css">
    <link rel="stylesheet" type="text/css" href="core/assets/css/vit-gallery.css">
    <link rel="shortcut icon" type="text/css" href="core/assets/images/favicon.png" />
    <link rel="stylesheet" type="text/css" href="core/assets/css/bootstrap-select.min.css">
...
<body>
            ...
            <div class="container">
                ...
                <div class="header-top header-top-v3 ">
                    <div class="header-top-left">
                        <span><i class="ion-ios-location-outline"></i> 5 avenue d'Aléry, 74000 Annecy</span>
                        <span><i class="fa fa-phone" aria-hidden="true"></i> 04 78 69 70 00</span>
                    </div>
                    ...
                    <a href="#" title="Skyline" class="logo-v3"><img src="core/assets/images/logo_white.png" class="img-responsive" alt="Image"></a>
                </div>
                <!-- END/HEADER-TOP -->
            </div>
        </div>
                    ...
                    <div id="rooms" class="owl-carousel owl-theme">
                        <div class="item ">
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 ">
                                <div class="wrap-box">
                                    <div class="box-img">
                                        <img src="core/assets/images/Home-1/our-1.jpg" class="img-responsive" alt="PLuxury Room" title="Luxury Room">
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 ">
                                <div class="wrap-box">
                                    <div class="box-img">
                                        <img src="core/assets/images/Home-1/our-2.jpg" class="img-responsive" alt="Double Room" title="Double Room">
                                    </div>
                                    <div class="rooms-content">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 ">
                                <div class="wrap-box">
                                    <div class="box-img">
                                        <img src="core/assets/images/Home-1/our-3.jpg" class="img-responsive" alt="Family Room" title="Family Room">
                                    </div>
                                    <div class="rooms-content">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 ">
                                <div class="wrap-box">
                                    <div class="box-img">
                                        <img src="core/assets/images/Home-1/our-4.jpg" class="img-responsive" alt="Deluxe Room" title="Deluxe Room">
                                    </div>
                                    <div class="rooms-content">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 ">
                                <div class="wrap-box">
                                    <div class="box-img">
                                        <img src="core/assets/images/Home-1/our-5.jpg" class="img-responsive" alt="Single Room" title="Single Room">
                                    </div>
                                    <div class="rooms-content">
                            ...
                            <div class=" col-lg-4 col-md-4 col-sm-6 col-xs-6 ">
                                <div class="wrap-box">
                                    <div class="box-img">
                                        <img src="core/assets/images/Home-1/our-6.jpg" class="img-responsive" alt="Presidential Room" title="Presidential Room">
                                    </div>
                                    <div class="rooms-content">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-7 col-lg-7 ">
                    <div class="about-img">
                        <div class="img-1">
                            <img src="core/assets/images/Home-1/about-3.jpg" class="img-responsive" alt="Image">
                            <div class="img-2">
                                <img src="core/assets/images/Home-1/about-1.jpg" class="img-responsive" alt="Image">
                            </div>
                            <div class="img-3">
                                <img src="core/assets/images/Home-1/about-2.jpg" class="img-responsive" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                    <div class="wrap-best">
                        <div class="icon-best">
                            <img src="core/assets/images/Home-1/about-icon-1.png" class="img-responsive" alt="Image">
                        </div>
                ...
                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                    <div class="wrap-best">
                        <div class="icon-best">
                            <img src="core/assets/images/Home-1/about-icon-2.png" class="img-responsive" alt="Image">
                        </div>
                ...
                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                    <div class="wrap-best">
                        <div class="icon-best">
                            <img src="core/assets/images/Home-1/about-icon-3.png" class="img-responsive" alt="Image">
                        </div>
                ...
                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                    <div class="wrap-best">
                        <div class="icon-best">
                            <img src="core/assets/images/Home-1/about-icon-4.png" class="img-responsive" alt="Image">
                        </div>
                ...
                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                    <div class="wrap-best">
                        <div class="icon-best">
                            <img src="core/assets/images/Home-1/about-icon-5.png" class="img-responsive" alt="Image">
                        </div>
                ...
                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                    <div class="wrap-best">
                        <div class="icon-best">
                            <img src="core/assets/images/Home-1/about-icon-6.png" class="img-responsive" alt="Image">
                        </div>
                ...
                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                    <div class="wrap-best">
                        <div class="icon-best">
                            <img src="core/assets/images/Home-1/about-icon-7.png" class="img-responsive" alt="Image">
                        </div>
                ...
                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                    <div class="wrap-best">
                        <div class="icon-best">
                            <img src="core/assets/images/Home-1/about-icon-8.png" class="img-responsive" alt="Image">
                        </div>
            ...
            <div class="testimonials-content">
                <div class="container">
                    <div id="testimonials" class="owl-carousel owl-theme">
                        <div class="item ">
                            <div class="img-testimonials"><img src="core/assets/images/Home-1/about-testimonials-img.png" alt="#"></div>
            ...
            <div id="events-v2" class="owl-carousel owl-theme">
                <div class="item ">
                    <div class="events-item">
                        <div class="events-img"><img src="core/assets/images/Home-1/Our-Events-1.jpg" class="img-responsive" alt="Image"></div>
                ...
                <div class="item">
                    <div class="events-item">
                        <div class="events-img"><img src="core/assets/images/Home-1/Our-Events-2.jpg" class="img-responsive" alt="Image"></div>
                        <div class="events-content">
                            <a href="#" title="">
                                <p class="sky-p">EVENTS</p>
                ...
                <div class="item">
                    <div class="events-item">
                        <div class="events-img"><img src="core/assets/images/Home-1/Our-Events-3.jpg" class="img-responsive" alt="Image"></div>
                        <div class="events-content">
                            <a href="#" title="">
                                <p class="sky-p">EVENTS</p>
                        ...
                        <div class="product ">
                            <div class="row">
                                <div class="gallery_product col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                                    <div class="wrap-box">
                                        <div class="box-img">
                                            <img src="core/assets/images/Home-1/gallery-1.jpg" class="img-responsive" alt="Product" title="images products">
                                        </div>
                                        <div class="gallery-box-main " title>
                                            <div class="gallery-icon">
                                                <a class="lightbox " href="core/assets/images/Home-1/gallery-1-1.jpg" data-littlelightbox-group="gallery" title="Luxury Room view all"><i class="ion-ios-plus-empty" aria-hidden="true" ></i> </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="gallery_product col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                                    <div class="wrap-box">
                                        <div class="box-img">
                                            <img src="core/assets/images/Home-1/gallery-2.jpg" class="img-responsive" alt="Product" title="images products">
                                        </div>
                                        <div class="gallery-box-main">
                                            <div class="gallery-icon">
                                                <a class="lightbox " href="core/assets/images/Home-1/gallery-2-2.jpg" data-littlelightbox-group="gallery" title="HIHI"><i class="ion-ios-plus-empty" aria-hidden="true" ></i> </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="gallery_product col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                                    <div class="wrap-box">
                                        <div class="box-img">
                                            <img src="core/assets/images/Home-1/gallery-3.jpg" class="img-responsive" alt="Product" title="images products">
                                        </div>
                                        <div class="gallery-box-main">
                                            <div class="gallery-icon">
                                                <a class="lightbox " href="core/assets/images/Home-1/gallery-3-3.jpg" data-littlelightbox-group="gallery" title="Flying is life"><i class="ion-ios-plus-empty" aria-hidden="true" ></i> </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="gallery_product col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                                    <div class="wrap-box">
                                        <div class="box-img">
                                            <img src="core/assets/images/Home-1/gallery-4.jpg" class="img-responsive" alt="Product" title="images products">
                                        </div>
                                        <div class="gallery-box-main">
                                            <div class="gallery-icon">
                                                <a class="lightbox " href="core/assets/images/Home-1/gallery-4-4.jpg" data-littlelightbox-group="gallery" title="Flying is life"><i class="ion-ios-plus-empty" aria-hidden="true" ></i> </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="gallery_product col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                                    <div class="wrap-box">
                                        <div class="box-img">
                                            <img src="core/assets/images/Home-1/gallery-5.jpg" class="img-responsive" alt="Product" title="images products">
                                        </div>
                                        <div class="gallery-box-main">
                                            <div class="gallery-icon">
                                                <a class="lightbox " href="core/assets/images/Home-1/gallery-5-5.jpg" data-littlelightbox-group="gallery" title="Flying is life"><i class="ion-ios-plus-empty" aria-hidden="true" ></i> </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="gallery_product col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                                    <div class="wrap-box">
                                        <div class="box-img">
                                            <img src="core/assets/images/Home-1/gallery-6.jpg" class="img-responsive" alt="Product" title="images products">
                                        </div>
                                        <div class="gallery-box-main">
                                            <div class="gallery-icon">
                                                <a class="lightbox " href="core/assets/images/Home-1/gallery-6-6.jpg" data-littlelightbox-group="gallery" title="Flying is life"><i class="ion-ios-plus-empty" aria-hidden="true" ></i> </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="gallery_product col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                                    <div class="wrap-box">
                                        <div class="box-img">
                                            <img src="core/assets/images/Home-1/gallery-7.jpg" class="img-responsive" alt="Product" title="images products">
                                        </div>
                                        <div class="gallery-box-main">
                                            <div class="gallery-icon">
                                                <a class="lightbox " href="core/assets/images/Home-1/gallery-7-7.jpg" data-littlelightbox-group="gallery" title="Flying is life"><i class="ion-ios-plus-empty" aria-hidden="true" ></i> </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="gallery_product col-lg-3 col-md-3 col-sm-6 col-xs-6 ">
                                    <div class="wrap-box">
                                        <div class="box-img">
                                            <img src="core/assets/images/Home-1/gallery-8.jpg" class="img-responsive" alt="Product" title="images products">
                                        </div>
                                        <div class="gallery-box-main">
                                            <div class="gallery-icon">
                                                <a class="lightbox " href="core/assets/images/Home-1/gallery-8-8.jpg" data-littlelightbox-group="gallery" title="Flying is life"><i class="ion-ios-plus-empty" aria-hidden="true" ></i> </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="gallery_product col-lg-3 col-md-3 col-sm-4 col-xs-6 ">
                                    <div class="wrap-box">
                                        ...
                                        <div class="gallery-box-main">
                                            <div class="gallery-icon">
                                                <a class="lightbox " href="core/assets/images/Home-1/gallery-2-2.jpg" data-littlelightbox-group="gallery" title="Flying is life"><i class="ion-ios-plus-empty" aria-hidden="true" ></i> </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-1 col-lg-1">
                        <div class="icon-email">
                            <a href="#" title="Email"><img src="core/assets/images/Home-1/footer-top-icon-l.png" alt="Email" class="img-responsive"></a>
                        </div>
                    </div>
                ...
                <div class="row padding-footer-mid">
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                        <div class="footer-logo text-center list-content">
                            <a href="index.html" title="Skyline"><img src="core/assets/images/Home-1/sky-logo-footer.png" alt="Image"></a>
                        </div>
                    </div>
                ...
                <div class="footer-bottom">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 no-padding">
                        <div class="payments text-right">
                            <ul>
                                <li>
                                    <a href="#" title="Paypal"><img src="core/assets/images/Home-1/Paypal.png" alt="Paypal"></a>
                                </li>
                                <li>
                                    <a href="#" title="Visa"><img src="core/assets/images/Home-1/Visa.png" alt="Visa"></a>
                                </li>
                                <li>
                                    <a href="#" title="Master"><img src="core/assets/images/Home-1/Master-card.png" alt="Master"></a>
                                </li>
                                <li>
                                    <a href="#" title="Discover"><img src="core/assets/images/Home-1/Discover.png" alt="Discover"></a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <!-- LOAD JQUERY -->
    <script type="text/javascript" src="core/assets/js/jquery-1.12.4.min.js"></script>
    <script type="text/javascript" src="core/assets/js/owl.carousel.min.js"></script>
    <script type="text/javascript" src="core/assets/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="core/assets/js/vit-gallery.js"></script>
    <script type="text/javascript" src="core/assets/js/jquery.countTo.js"></script>
    <script type="text/javascript" src="core/assets/js/jquery.appear.min.js"></script>
    <script type="text/javascript" src="core/assets/js/isotope.pkgd.min.js"></script>
    <script type="text/javascript" src="core/assets/js/bootstrap-select.js"></script>
    <script type="text/javascript" src="core/assets/js/jquery.littlelightbox.js"></script>
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.7.1/js/bootstrap-datepicker.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBDyCxHyc8z9gMA5IlipXpt0c33Ajzqix4"></script>
    <!-- Custom jQuery -->
    <script type="text/javascript" src="core/assets/js/sky.js"></script>
